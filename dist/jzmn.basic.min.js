...
return void 0!==t?t:r}))}return{wrapped:a(u),bare:u.length>1?u:u[0],self:a(this.els),"bare || self":void 0===u?a(this.els):u}[r.output]}}),n},a.extendFactory=function(n,e,r){var t=n?a[n]||(a[n]={}):a
