...
e.el=document.querySelector.bind(document),e.els=document.querySelectorAll.bind(document),e.setParser("dom",function(e){return e?Array.isArray(e)?e:e.nodeType?[e]:r(e)?n.slice.call(e):t(e)?n.slice.call(document.querySelectorAll(e)):[e]:[]}),e.extendFactory("dom",{attr:function(e,t,n){return void 0!==n?null===n?e.removeAttribute(t):e.setAttribute(t,n):e.getAttribute(t)},find:function(e,t){return Array.prototype.slice.apply(e.querySelectorAll(t))},ancestor:function(e,t){return t?e.closest(t):e.parentNode},html:function(e,t){return void 0===t?e.innerHTML:void(e.innerHTML=t)},on:function(e,t,n){e.addEventListener(t,n)},delegate:function(e,t,n,r){e.addEventListener(n,function(e){e.target.matches(t)&&r(e)})}}),e.extendFn({attr:e.dom.attr},{output:"bare"})}(jzmn)
var jzmn=function(e){"use strict"
